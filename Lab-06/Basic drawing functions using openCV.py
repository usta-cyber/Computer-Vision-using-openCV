# Lab-06:Basic Drawing Functions using OpenCV
'''
Read image & resizing
Create blank image (black , white)
Draw line and arrow head line
...
img = cv2.putText(img, 'Computer Vision', (20, 500), font, 2, (0, 125, 255), 5,cv2.LINE_AA)
